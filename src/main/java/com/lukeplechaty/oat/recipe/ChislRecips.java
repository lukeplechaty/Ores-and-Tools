...
public class ChislRecips
{
	...
	public static void recipe()
	{
		try
		{
			...
			for(int a=-1;a<16;a++)
			{
				ChislHandler.addtolist(Blocks.STAINED_GLASS,a,new ItemStack(Blocks.STAINED_GLASS,1,a),Blocks.AIR,1);
				ChislHandler.addtolist(Blocks.STAINED_GLASS_PANE,a,new ItemStack(Blocks.STAINED_GLASS_PANE,1,a),Blocks.AIR,1);
			}
		}
		catch(Exception e)
		{
