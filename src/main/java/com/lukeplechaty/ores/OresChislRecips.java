...
public class OresChislRecips
{
	...
	static void recipe()
	{
		...
		try
		{
			...
			ChislHandler.addtolist("oreIron",new ItemStack(Ores.items,1,6),new ItemStack(cobble),2);
			ChislHandler.addtolist("oreGold",new ItemStack(Ores.items,1,7),new ItemStack(cobble),3);
			...
			ChislHandler.addtolist(new ItemStack(Blocks.lit_redstone_ore),new ItemStack(Items.redstone,5,0),new ItemStack(cobble),3);
			...
			ChislHandler.addtolist("oreTin",new ItemStack(Ores.items,1,8),new ItemStack(cobble),2);
			ChislHandler.addtolist("oreCopper",new ItemStack(Ores.items,1,9),new ItemStack(cobble),2);
			ChislHandler.addtolist("oreSilver",new ItemStack(Ores.items,1,10),new ItemStack(cobble),3);
			ChislHandler.addtolist("oreLead",new ItemStack(Ores.items,1,11),new ItemStack(cobble),3);
			ChislHandler.addtolist("oreNickel",new ItemStack(Ores.items,1,12),new ItemStack(cobble),3);
			ChislHandler.addtolist("orePlatinum",new ItemStack(Ores.items,1,13),new ItemStack(cobble),3);
			ChislHandler.addtolist("oreAluminum",new ItemStack(Ores.items,1,14),new ItemStack(cobble),3);
