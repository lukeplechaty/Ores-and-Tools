...
public class OresRegister
{
	public static void register()
	{
		...
		OresControl.addOre("dustIron",new ItemStack(Ores.dusts,1,0));
		OresControl.addOre("dustGold",new ItemStack(Ores.dusts,1,1));
		OresControl.addOre("dustTin",new ItemStack(Ores.dusts,1,2));
		OresControl.addOre("dustCopper",new ItemStack(Ores.dusts,1,3));
		OresControl.addOre("dustSilver",new ItemStack(Ores.dusts,1,4));
		OresControl.addOre("dustLead",new ItemStack(Ores.dusts,1,5));
		OresControl.addOre("dustNickel",new ItemStack(Ores.dusts,1,6));
		OresControl.addOre("dustPlatinum",new ItemStack(Ores.dusts,1,7));
		OresControl.addOre("dustAluminum",new ItemStack(Ores.dusts,1,8));
		OresControl.addOre("dustAluminium",new ItemStack(Ores.dusts,1,8));
		OresControl.addOre("dustMithril",new ItemStack(Ores.dusts,1,9));
		OresControl.addOre("dustCobalt",new ItemStack(Ores.dusts,1,10));
		OresControl.addOre("dustArdite",new ItemStack(Ores.dusts,1,11));
		OresControl.addOre("dustYellorium",new ItemStack(Ores.dusts,1,12));
		OresControl.addOre("dustFlour",new ItemStack(Ores.dusts,1,13));
		OresControl.addOre("dustSaltpeter",new ItemStack(Ores.dusts,1,14));
		OresControl.addOre("dustSulfur",new ItemStack(Ores.dusts,1,15));
		OresControl.addOre("dustCharcoal",new ItemStack(Ores.dusts,1,16));
